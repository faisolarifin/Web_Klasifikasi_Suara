...
function createDownloadLink(blob) {
	...
	link.innerHTML = "<button class='btn btn-secondary btn-sm btn-block mt-2'>Download Audio</button>";
	...
	upload.href="#";
	upload.innerHTML = "<button class='btn btn-info btn-sm btn-block mt-3'>Identification</button>";
